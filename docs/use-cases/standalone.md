...
all in
[console-sources.md](../console-sources.md#static-source).
...
The compose demo in
[installation.md](../installation.md#try-it-the-demo-stack) is
...
under
[What the demo is not](../installation.md#what-the-demo-is-not),
...
nightly.
[testing.md](../testing.md#the-direct-qemu-lane) covers the
lane, and
[direct-qemu-harness.md](../direct-qemu-harness.md) covers the
...
[documentation index](../index.md). This is the deployment with
...
- [Console Sources](../console-sources.md#static-source) — the
  option reference for `type: static`, the example entry, and
  the ryll control-socket pairing
- [Installation](../installation.md#try-it-the-demo-stack) — the
...
- [Testing](../testing.md#the-direct-qemu-lane) — the CI lanes,
