...
[console-sources.md](../console-sources.md#ovirt). General
settings, including `PUBLIC_FQDN` and the proxy's own ports and
CA, are in [configuration.md](../configuration.md).
...
[documentation index](../index.md). For oVirt there is no
...
- [Console Sources](../console-sources.md#ovirt) — the option
