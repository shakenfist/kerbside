...
[console-sources.md](../console-sources.md#openstack); two
...
[testing.md](../testing.md#tempest-tests-against-a-kolla-ansible-deployment)
...
[documentation index](../index.md). OpenStack is the case where
...
- [Console Sources](../console-sources.md#openstack) — the
  option reference for OpenStack sources, and the on-demand
  model in general
- [Configuration](../configuration.md) — proxy settings,
...
- [Testing](../testing.md#tempest-tests-against-a-kolla-ansible-deployment)
