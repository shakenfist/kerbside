...
1. **sf-e2e promotion criteria.** Proposal: N consecutive
   ...
   **Resolved 2026-08-08 (maintainer decision):** N=10
   ...
   [PLAN-two-tier-ci-phase-02-sf-e2e-promotion.md](PLAN-two-tier-ci-phase-02-sf-e2e-promotion.md).
...
| 3. Merge queue adoption and tier split | [PLAN-two-tier-ci-phase-03-merge-queue.md](PLAN-two-tier-ci-phase-03-merge-queue.md) | Complete — queue live 2026-08-09 |
...
[Proxmox console source](PLAN-proxmox-source.md). In short —
