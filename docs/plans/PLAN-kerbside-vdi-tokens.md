...
| 9. Full cross-repo end-to-end lane + kerbside exchange/proxy lane + KERBSIDE_URL provisioning (real SF, post-merge) | [PLAN-kerbside-vdi-tokens-phase-09-e2e.md](PLAN-kerbside-vdi-tokens-phase-09-e2e.md) | Done |
