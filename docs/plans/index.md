...
| 2026-08-02 | [Two-tier CI](PLAN-two-tier-ci.md) | Adopt the shakenfist/shakenfist two-tier CI flow: smoke gates (sanity, direct-qemu, Rust, single-node sf-e2e) on PRs; oVirt and Kolla/OpenStack move to a merge-queue tier; fix the oVirt lane to actually deploy kerbside; record the oVirt front-door architecture decision | Draft, blocked on sf-e2e PR-readiness | [phase 1](PLAN-two-tier-ci-phase-01-ovirt-kerbside.md) (planned), phases 2-4 not yet planned |
