...
- **Daemon lane: the real integration path, in CI.** The direct-qemu
  ...
  [plans/PLAN-rust-proxy-phase-07-ci.md](plans/PLAN-rust-proxy-phase-07-ci.md).
...
- End-to-end relay through the proxy (2026-07-06):
  [plans/PLAN-rust-proxy-phase-03-proxy-skeleton.md](plans/PLAN-rust-proxy-phase-03-proxy-skeleton.md),
  step 3h.
- Firewall warn-only capture and deny path (2026-07-07):
  [plans/PLAN-rust-proxy-phase-04-firewall.md](plans/PLAN-rust-proxy-phase-04-firewall.md),
  step 4f.
- Live session termination (2026-07-08):
  [plans/PLAN-rust-proxy-phase-05-daemon-integration.md](plans/PLAN-rust-proxy-phase-05-daemon-integration.md),
  step 5f.
